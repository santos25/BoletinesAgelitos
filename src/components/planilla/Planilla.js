...
class Planilla extends Component {
  ...
  findPlanillasByPeriodAndGrado() {
    Base.fetch('planillas', {
      ...
      .then((data) => {
        let planilla = data.filter( (planilla) => planilla.periodo === this.props.periodoSelected &&   planilla.ano === 2023
        );
      ...
      .then((data) => {
        ...
        if (booleanToKnowIdPlanilla) {
          ...
          if (planilla[0][asignaturaKey]) {
            ...
            this.uploadStudents(
              this.props.gradoSelected.estudiantes,
              planilla[0].key
            );
            // this.getObervacionesStudent(planilla[0].observaciones);
          }
  ...
  createNewPlanilla() {
    ...
    Base.post(
      `planillas/${
        ...
        this.props.gradoSelected.nombre +
        this.props.periodoSelected
      }`,
      {
        data: planilla,
      }
      ...
      <Grid>
        ...
        <Row className="show-grid">
          ...
          <Col xs={12} md={6}>
            <ControlsSelect
              ...
              data={this.excludeAsignatureByGrade(this.state.asignaturas)}
            />
          </Col>
        </Row>
        <Row>
          ...
          <Col xs={12} md={12}>
            <Table striped bordered condensed hover>
              ...
              <RowTable
                ...
                onChangeObservaciones={this.onChangeObservacionStudent.bind(
                  this
                )}
        ...
        <Row>
          <Col xs={12} md={12}>
            <div className="formPlanilla">
              <Button
                disabled={this.state.keyAsignaturaSelected ? false : true}
                bsStyle="primary"
                type="submit"
                bsSize="large"
